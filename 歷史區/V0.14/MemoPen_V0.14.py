...
#    nuitka-project: --product-version=0.14.0.0
#    nuitka-project: --file-version=0.14.0.0
...
class MemoPenWindow(QWidget):
    ...
    def save_to_current_path(self, *, show_error: bool, force: bool) -> bool:
        ...
        try:
            ...
            if save_file.write(data) != len(data):
                ...
                raise OSError(save_file.errorString() or "檔案寫入不完整")
    ...
    def closeEvent(self, event) -> None:  # noqa: N802
        ...
        self.save_to_current_path(show_error=False, force=True)
        event.accept()
